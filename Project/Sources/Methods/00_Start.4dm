...
Case of 
	...
	Else 
		...
		$options.title:=""
		$options.title:=$options.title+"merge and split cells in 4D Write Pro tables?"  //+"\n"
		//$options.title:=$options.title+"tables in  documents?"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D Write Pro feature"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="2020"  // 2000 means 20.0   2020 means 20R2, 2001 means 20.1 (do not use !)
