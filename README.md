...
Merge cells in [4D Write Pro](https://us.4d.com/4D-write-pro) documents (4D v20 R2)

Find more information on the [blog post](https://blog.4d.com/4d-write-pro-tables-introducing-cells-merge/).
